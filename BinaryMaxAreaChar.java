...
public class BinaryMaxAreaChar {
    public static void main(String[] args) {
        ...
        BinaryMaxAreaChar bac = new BinaryMaxAreaChar();
        System.out.println(bac.maxArea(m, m.length, m[0].length));
    }

    public int maxArea(char ch[][], int n, int m) {
        int[][] M = new int[n][m];
